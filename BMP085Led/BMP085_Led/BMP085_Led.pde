...
void loop(void) 
{
  ...
  lc.setDigit(0, 6, (Temperature / 100) % 10, false);
  lc.setDigit(0, 5, (Temperature / 10) % 10, false);
  lc.setDigit(0, 4, (Temperature) % 10, false);
  
  lc.setDigit(0, 3, (Altitude / 100000) % 10, false);
  lc.setDigit(0, 2, (Altitude / 10000) % 10, false);
  lc.setDigit(0, 1, (Altitude / 1000) % 10, false);
  lc.setDigit(0, 0, (Altitude / 100) % 10, false);
